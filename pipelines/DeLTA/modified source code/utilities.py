...
def roi_features(
        ...
        features: Tuple[str, ...] = ("length", "width", "area", "perimeter", "edges", "x_center", "y_center",
                                     "orientation", "rectangle_width", "rectangle_height"),
...
def singlecell_features(
    ...
    if "length" in features or "width" in features or "x_center" in features or "y_center" in features or\
            "orientation" in features or "rectangle_width" in features or "rectangle_height" in features:
        width, length, x_center, y_center, orientation, rectangle_width, rectangle_height =\
            cell_width_length_center_orientation(contour)
        if "length" in features:
            features_dict["length"] = length
        if "width" in features:
            features_dict["width"] = width
        if "x_center" in features:
            features_dict["x_center"] = x_center
        if "y_center" in features:
            features_dict["y_center"] = y_center
        if "orientation" in features:
            features_dict["orientation"] = orientation
        if "rectangle_width" in features:
            features_dict["rectangle_width"] = rectangle_width
        if "rectangle_height" in features:
            features_dict["rectangle_height"] = rectangle_height
...
def cell_width_length_center_orientation(contour: Contour) -> Tuple[float, float, float, float, float, float, float]:
    """
    Mesure: width, length, x_center, y_center, orientation, rectangle_width, rectangle_height
    ...
    rectangle_width = rotrect[1][0]
    rectangle_height = rotrect[1][1]

    return width, length, x_center, y_center, orientation, rectangle_width, rectangle_height
