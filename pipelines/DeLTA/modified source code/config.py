...
memory_growth_limit: Optional[float] = 8192
...
_DEFAULTS_2D = dict(
    ...
    memory_growth_limit=8192,  # If running into OOM issues or having trouble with cuDNN loading, try setting memory_growth_limit to a value in MB: (eg 1024, 2048...)
