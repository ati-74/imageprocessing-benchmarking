...
def edge_list_to_adjmatrix(col1, col2):
    """
...
def plot_graph(G, TimeStep, output_directory):
    """
    ...
    plt.title("Graph of neighboring bacteria at timestep " + str(TimeStep))
    # plt.show()
    fig.savefig(
        output_directory + "/img/graph/graph_t" + str(TimeStep) + ".png", dpi=300
    )
    # close fig
    fig.clf()
    plt.close()
