    ...
    def process(
        ...
        for p in positions:
            ...
            self.positions[p].save(
                filename= self.resfolder / ("Position%06d" % (p)),
                frames=frames,
...
class Position:
    ...
    def features(
        ...
        features : list or tuple of str, optional
            ...
            The default is ("length", "width", "area", "perimeter", "edges" ,"x_center" , "y_center" , "orientation").
