...
<p align="justify"><b><i><span style="color:blue">tracking-plotbac.py</span>:</i></b> This script creates visualizations for the tracking output of various tools. You'll find
